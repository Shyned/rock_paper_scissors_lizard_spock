...
class Human_Ai(Player):
    def __init__(self):
        super().__init__()
        self.robo_names = ["R2D2","Johnny5","kitt","Bender"]
        self.cpu_name = choice(self.robo_names)
        self.name = ""
        self.enter_name()
        self.player1 = ''
        self.cpu_choice = ''
    ...
    def enter_name(self):
        while len(self.name) < 5:
            ...
            print(f"You are facing {self.cpu_name}")
            pass
    ...
    def players_choice(self):
        ...
        # robot pick random item from list
            ...
            print(f"{self.cpu_name} has picked {self.cpu_choice}")
    ...
    def repeat_till_over(self):
        while True:
            if self.player1_points < 2 and self.cpu_points < 2:
                ...
                self.point_check()
                print(
                    f"You have {self.player1_points} points and {self.cpu_name} has {self.cpu_points} points")
